...
$.fn.slideWiz = function(e) {
    ...
    var move = true,
        ...
        pixel = 0,
        pixel_arr = [],
        col = (is_numeric(object.col) ? object.col : 30),
        row = (is_numeric(object.row) ? object.row : 6);
    ...
    var slide = function(direction) {
        ...
        var holder = $('.slide-container .slide-holder'),
            ...
            tm, _tm, position, children = holder.children(),
            child_length = children.length,
            t_m = null,
            c = 0,
            x = 0,
            func_first, func_sec, func_third, func_fourth,
            max_width = holder.width(),
            max_height = holder.height(),
            min_width = (max_width / col),
    ...
    var slide_container = $('<div>').attr('class', 'slide-container'),
        ...
        detail_box = $('<div>').attr('class', 'detail-box'),
        i = 0;
    ...
    $(this).append(slide_container.append(slide_holder)
        .append(main_image_box).append(detail_box)
        // .append(
        //     $('<button>').attr({
    ...
    var delay = setTimeout(function() {
        ...
        var max_width = $('.slide-holder').width(),
            max_height = $('.slide-holder').height(),
            min_width = (max_width / col),
            min_height = (max_height / row),
            children = $('.slide-holder').children('div'),
            child_length = children.length,
            img_height = $(children[0]).children('img').innerHeight(),
            i = 0,
            x = col,
            v = 0,
            b = 0,
